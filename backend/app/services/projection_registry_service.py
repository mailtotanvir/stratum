...
PROJECTION_QUERY_METADATA: dict[str, dict[str, Any]] = {
    ...
    "evaluation_coverage": {
        ...
        "route": "/evaluation-coverage/projection",
        "supported_filters": [],
    },
    "evaluation_drift": {
        "category": "evaluations",
        "route": "/evaluation-drift/projection",
        "supported_filters": [],
    },
    "evaluation_intelligence_overview": {
        "category": "evaluations",
        "route": "/evaluation-intelligence-overview/projection",
        "supported_filters": [],
    },
    ...
    "evaluation_lineage": {
        "category": "evaluations",
        "route": "/evaluation-lineage/projection",
        "supported_filters": [],
    },
    "evaluation_registry": {
        "category": "evaluations",
        "route": "/evaluation-registry/projection",
        "supported_filters": [],
    },
    "evaluation_summary": {
        "category": "evaluations",
    ...
    "repository_memory": {
        "category": "memory",
        "route": "/runtime/memory/repository",
        "supported_filters": [],
    },
    ...
    "session_memory": {
        "category": "memory",
        "route": "/runtime/memory/sessions/{session_id}",
        "supported_filters": ["session_id"],
    },
    "working_memory": {
        "category": "memory",
        "route": "/runtime/memory/working",
        "supported_filters": ["session_id"],
    },
}
...
def default_projection_contracts() -> list[ProjectionContract]:
    return [
        ...
        ProjectionContract(
            projection_name="decision_effectiveness",
            projection_version=1,
            projection_description="Summarizes evaluated outcomes for recorded runtime decisions.",
        ...
        ProjectionContract(
            projection_name="evaluation_coverage",
            projection_version=1,
            projection_description="Summarizes deterministic evaluation coverage across registered runtime targets.",
            projection_owner="runtime",
        ...
        ProjectionContract(
            projection_name="evaluation_drift",
            projection_version=1,
            projection_description="Summarizes deterministic evaluation drift from registered baselines and observations.",
            projection_owner="runtime",
            projection_category="evaluation",
            supports_replay=True,
            supports_drift_detection=True,
        ...
        ProjectionContract(
            projection_name="evaluation_intelligence_overview",
            projection_version=1,
            projection_description="Aggregates registry, lineage, coverage, and drift projections for evaluation governance visibility.",
            projection_owner="runtime",
            projection_category="evaluation",
            supports_replay=True,
            supports_drift_detection=True,
        ...
        ProjectionContract(
            projection_name="evaluation_lineage",
            projection_version=1,
            projection_description="Traces evaluation lineage and evidence back to governed runtime sources.",
            projection_owner="runtime",
            projection_category="evaluation",
            supports_replay=True,
            supports_drift_detection=True,
        ...
        ProjectionContract(
            projection_name="evaluation_registry",
            projection_version=1,
            projection_description="Registers governed evaluation definitions and suites.",
            projection_owner="runtime",
            projection_category="evaluation",
            supports_replay=True,
            supports_drift_detection=True,
        ...
        ProjectionContract(
            projection_name="governance_health_rollup",
            projection_version=1,
            projection_description="Summarizes governance health across evaluation, policy, recommendation, and decision surfaces.",
            projection_owner="governance",
            projection_category="governance",
            supports_replay=True,
            supports_drift_detection=True,
        ...
        ProjectionContract(
            projection_name="recommendation_outcome",
            projection_version=1,
            projection_description="Connects planner recommendations to selected and evaluated outcomes.",
            projection_owner="runtime",
            projection_category="recommendation",
            supports_replay=True,
            supports_drift_detection=True,
            supports_reconstruction=True,
            supports_analytics=True,
        ...
        ProjectionContract(
            projection_name="repository_memory",
            projection_version=1,
            projection_description="Summarizes repository-level derived memory from runtime events and artifacts.",
            projection_owner="runtime",
            projection_category="memory",
            supports_replay=True,
            supports_drift_detection=True,
            supports_reconstruction=True,
            supports_analytics=True,
        ...
        ProjectionContract(
            projection_name="session_memory",
            projection_version=1,
            projection_description="Summarizes session-level derived memory from runtime events and artifacts.",
            projection_owner="runtime",
            projection_category="memory",
            supports_replay=True,
            supports_drift_detection=True,
        ...
        ProjectionContract(
            projection_name="working_memory",
            projection_version=1,
            projection_description="Summarizes the active working memory for a runtime session.",
            projection_owner="runtime",
            projection_category="memory",
            supports_replay=True,
            supports_drift_detection=True,
