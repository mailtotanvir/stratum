...
class EventType(StrEnum):
    ...
    INVOCATION_QUEUED = "invocation_queued"
    INVOCATION_STARTED = "invocation_started"
    INVOCATION_PROGRESS = "invocation_progress"
    INVOCATION_WAITING = "invocation_waiting"
    INVOCATION_WAITING_FOR_APPROVAL = "invocation_waiting_for_approval"
    ...
    EVALUATION_SCENARIO_REGISTERED = "evaluation_scenario_registered"
